"""Minimal Gemma/PaliGemma helpers for Pi05."""
...
def compute_shared_attention_layer(
    ...
    if getattr(paligemma.config.text_config, "_pi05_variant", None) == "gemma_tiny":
...
class PaliGemmaWithExpertModel(nn.Module):
    ...
    def __init__(
        ...
        paligemma_config.text_config._pi05_variant = vlm_config.variant
