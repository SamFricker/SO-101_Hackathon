...
**Lobster Sort** is an autonomous clothes-sorting robot built with a 6-DOF [SO-101](https://github.com/TheRobotStudio/SO-ARM100) arm, a bird's-eye USB camera, and an [Atech.dev](https://atech.dev) humidity sensor. It detects a sock in the workspace, picks it up, measures moisture at a fixed sensor station, and deposits it into a **wet** or **dry** bin. The project was made for the physical AI hardware hackathon hosted by **Oxford Artificial Intelligence Society** & **Oxford Edge** with hardware from **Foundry Robotics, Quanser, Atech, Hugging Face LeRobot, LeKiwi,** & **Amazing Hand**. Coding credits from **Anthropic, Cursor, Neuracore,** & **Lovable**. Overall in a team of 5 (team name: Hermit), over the time of two days, with 16 hours of lab time we were able to sucessfully produce a live demo of the system for judging.
